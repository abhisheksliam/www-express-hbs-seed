...
(function() {
	...
	function DashboardService () {
		...
		dashboard.setHeights = function () {
			...
			$('.widget-progress-bar').css('margin-top', clockHeight - widgetProgressHeight - 3);
		}
