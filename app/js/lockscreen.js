$(function() {
    $.backstretch(["assets/gallery/login4.jpg", "assets/gallery/login3.jpg", "assets/gallery/login2.jpg", "assets/gallery/login.jpg"], {
        fade: 600,
        duration: 4000
    });
    ...
    /* Background Slide */
    $('.bg-slider').backstretch(["assets/gallery/login4.jpg", "assets/gallery/login3.jpg", "assets/gallery/login2.jpg", "assets/gallery/login.jpg"], {
        fade: 600,
        duration: 4000
    });
    ...
    $('#image-cb').change(function() {
        if ($(this).is(":checked")) {
            $.backstretch(["assets/gallery/login.jpg"], {
                fade: 600,
                duration: 4000
            });
